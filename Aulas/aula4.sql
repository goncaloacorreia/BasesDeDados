...
--c
select NomeA
from autor1, autoria, exemplar, biblioteca
where cidade = 'Evora' and autor1.CodA = autoria.CodA and autoria.ISBN = exemplar.ISBN and exemplar.idBib = biblioteca.idBib;

--d
select titulo, count(idLivro) as nEx
from livro, exemplar
